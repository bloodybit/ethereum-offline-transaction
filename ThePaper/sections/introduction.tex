...
To resolve identifiers to the actual user profile location, SONIC takes advantage of a distributed system called\texit{Global Social Lookup System} (GSLS) \cite{gondor_distributed_2016}. User's \texit{GobalID} and profile location are stored in an dataset, called \texit{Social Record}, managed by the GSLS \cite{gondor_distributed_2016}.
\\
