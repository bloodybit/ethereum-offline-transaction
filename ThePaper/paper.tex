...
\include{sections/introduction} % introduction to the topic 
\include{sections/relatedWorks} % theoretical framework and literature study 
\include{sections/transaction} 
\include{sections/implementation} % research questions and hypotheses
\include{sections/methods}      % methods use to validate our assumptionsap
\include{sections/evaluation}   % result and analysis 
\include{sections/conclusion}   % discussion
